...
export const users: User[] = [
  { id: 'user-1', name: 'Aisha', age: 28, bio: 'Lover of art, travel, and good food. Looking for someone to explore Lagos with.', location: 'Lagos, Nigeria', job: 'Art Curator', education: 'University of Lagos', interests: ['Art', 'Travel', 'Foodie', 'Music', 'Dancing', 'Yoga', 'Events'], photos: ['user-1', 'user-5', 'user-9', 'user-11'], isVerified: true, lastSeen: 'online', socials: { instagram: '@aisha_art', spotify: 'aisha-jams' } },
  { id: 'user-2', name: 'Bolu', age: 32, bio: 'Software engineer by day, musician by night. Let\'s talk tech, afrobeats, and everything in between.', location: 'Abuja, Nigeria', job: 'Software Engineer', education: 'Covenant University', interests: ['Tech', 'Music', 'Movies', 'Gaming'], photos: ['https://images.unsplash.com/photo-1589635823089-774fca28fe13?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxhJTIwbmlnZXJpYSUyMGd1eXxlbnwwfHx8fDE3NjgwNzE2OTh8MA&ixlib=rb-4.1.0&q=80&w=1080', 'user-6', 'user-10', 'user-12'], isVerified: true, lastSeen: new Date(Date.now() - 1000 * 60 * 3), socials: { instagram: '@bolu_codes' } },
  { id: 'user-3', name: 'Chioma', age: 25, bio: 'Fashion designer with a passion for sustainability. My perfect date is a walk in the park or visiting a gallery.', location: 'Port Harcourt, Nigeria', job: 'Fashion Designer', education: 'Yaba College of Technology', interests: ['Fashion', 'Nature', 'Art', 'Yoga'], photos: ['https://images.unsplash.com/photo-1756485161657-e005fc9e4393?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw2fHxhJTIwbmlnZXJpYW4lMjBsYWR5fGVufDB8fHx8MTc2ODA3MTc4MHww&ixlib=rb-4.1.0&q=80&w=1080', 'user-7', 'user-13-2', 'user-14-2'], isVerified: false, lastSeen: new Date(Date.now() - 1000 * 60 * 8) },
  { id: 'user-4', name: 'Deji', age: 30, bio: 'Fitness enthusiast and entrepreneur. If you can keep up with me at the gym, you might be the one.', location: 'Ibadan, Nigeria', job: 'Entrepreneur', education: 'University of Ibadan', interests: ['Fitness', 'Business', 'Reading', 'Hiking'], photos: ['https://images.unsplash.com/photo-1667772538186-144083f87515?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8YSUyMG5pZ2VyaWElMjBndXl8ZW58MHx8fHwxNzY4MDcxNjk4fDA&ixlib=rb-4.1.0&q=80&w=1080', 'user-8', 'user-15-2', 'user-17-2'], isVerified: true, lastSeen: 'online', socials: { spotify: 'deji-lifts' } },
...
export const potentialMatches: User[] = users.slice(1, 5);
